...
try {
  ...
  // Reverse geocoding
  const resGeo = await fetch(`https://api.bigatacloud.net/data/reverse-geocode-client?latitude=${lat}&longitude=${lng}`);
...
whereAmI();
console.log('FIRST');
const codes = fetch('https://restcountries.com/v3.1/all');
console.log(codes);
